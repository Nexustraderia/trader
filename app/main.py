...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at 20% 0,#162443 0,#080d18 45%);color:#f6f8fb;font:15px Inter,system-ui,-apple-system,Segoe UI,Arial,sans-serif;min-height:100vh}
    .wrap{max-width:920px;margin:auto;padding:28px 16px 48px}.brand{display:flex;justify-content:space-between;align-items:center;gap:16px;margin-bottom:24px}.brand h1{font-size:22px;letter-spacing:.04em;margin:0}.brand p{color:var(--muted);margin:7px 0 0}.pulse{display:flex;align-items:center;gap:8px;color:var(--green);font-size:12px}.dot{width:9px;height:9px;border-radius:50%;background:var(--green);box-shadow:0 0 14px var(--green)}
